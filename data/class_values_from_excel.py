...
df_merged = df_merged[df_merged["lower_workpiece_id"]=="workpiece_not_labeled"]

df_merged

upper_workpiece_id	lower_workpiece_id_upper	class_value_upper_work_piece	lower_workpiece_id_lower	class_value_lower_work_piece	class_value_tightening_process	lower_workpiece_id